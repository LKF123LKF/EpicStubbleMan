...
public class AudioManager extends Thread {
    ...
    public void run() {
        for (; running; running = false) {
            ...
            else if (getTrack() == "jump")
                try {
                    clip[1].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "crash")
                try {
                    clip[2].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "bonk")
                try {
                    clip[4].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "next_level")
                try {
                    clip[5].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "pwned")
                try {
                    clip[6].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "evil_laugh")
                try {
                    clip[8].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "menu_changed")
                try {
                    clip[9].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "menu_entered")
                try {
                    clip[10].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "menu_exited")
                try {
                    clip[11].play();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            else if (getTrack() == "welcome")
                try {
                    clip[12].play();
                } catch (Exception e) {
                    e.printStackTrace();
