        ...
        if (!player.dead) {
            ...
            for (int i = 0; i < getPathSize(); i++) {
                ...
                if (playerRect.intersects(currRect)) {
                    ...
                    if (player.getX() < (double) currRect.x) {
                        ...
                        player.setDx(0);
                    } else if (player.getX() > (double) currRect.x) {
            ...
            for (int i = 0; i < getSpikeSize(); i++) {
                ...
                if (player.getY() < spRect.y && !spike.isUpwardFacing()) {
                    ...
                    canDie = false;
                } else if (player.getY() > spRect.y && !spike.isUpwardFacing()) {
                    player.reset();
                    player.dead = true;
                    player.grounded = true;
                    break;
            ...
            for (int i = 0; i < elevators.size(); i++) {
                ...
                if (playerRect.intersects(fp)) {
                    ...
                    } else if (player.getX() < (double) fp.x) {
            ...
            for (int i = 0; i < bridges.size(); i++) {
                ...
                if (playerRect.intersects(bp)) {
                    ...
                    } else if (player.getY() > bp.y) {
                        if (player.isRising()) {
                            mam.playTrack("bonk");
                            player.setPeak(true);
                        }
                    } else if (player.getX() < (double) bp.x) {
                        player.shoveLeft(1.0D);
                        player.setDx(0);
                    } else if (player.getX() > (double) bp.x) {
                        player.shoveRight(1.0D);
                        ...
                        for (int j = 0; j < bridges.size(); j++) {
                            ...
                            if (bridgePiece != mp && bridgeRect.intersects(mpRect)) {
                                ...
                                if (bridgePiece.isContinuous())
                                    ...
                                    else if (bridgePiece.getX() < (double) mpRect.x)
